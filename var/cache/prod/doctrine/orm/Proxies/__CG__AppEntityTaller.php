 ...
 */
class Taller extends \App\Entity\Taller implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Taller' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Taller' . "\0" . 'titulo', '' . "\0" . 'App\\Entity\\Taller' . "\0" . 'descripcion', '' . "\0" . 'App\\Entity\\Taller' . "\0" . 'fecha', '' . "\0" . 'App\\Entity\\Taller' . "\0" . 'foto'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Taller $proxy) {
